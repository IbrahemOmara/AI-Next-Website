...
import EconomicCalendar from "./components/pages/EconomicCalendar/EconomicCalendar"
import StockHeatmap from "./components/pages/StockHeatmap/StockHeatmap"
import StockScreener from "./components/pages/StockScreener/StockScreener"
...
import PowerWave from "./components/pages/Courses/PowerWave";
import OppenheimerScanner from "./components/pages/Courses/OppenheimerScanner";
import ChartBlazeScanner from "./components/pages/Courses/ChartBlazeScanner";
import CourseDetails from "./components/pages/Courses/CourseDetails";
import TopNews from "./components/pages/TopNews/TopNews";
import MarketHours from "./components/pages/MarketHours/MarketHours";
import Charts from "./components/pages/Charts/Charts";
import MarketWatch from "./components/pages/MarketWatch/MarketWatch";
  ...
  let routes = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "power-wave", element: <PowerWave /> },
        { path: "oppenheimer-scanner", element: <OppenheimerScanner /> },
        { path: "chartblaze-scanner", element: <ChartBlazeScanner /> },
        { path: "stock-heatmap", element: <StockHeatmap /> },
        { path: "stock-screener", element: <StockScreener /> },
        { path: "top-news", element: <TopNews /> },
        { path: "market-hours", element: <MarketHours /> },
